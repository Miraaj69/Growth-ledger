// App.js — Root with navigation, fonts, and providers
        ...
        {state.routes.map((route, index) => {
          ...
          return (
            <View key={route.key} style={tbStyles.tab}>
              <View onStartShouldSetResponder={() => true} onResponderGrant={onPress} style={[tbStyles.tabInner, isFocused && tbStyles.tabActive]}>
...
const tbStyles = StyleSheet.create({
  container: {
    ...
    backgroundColor: Platform.OS === 'android' ? 'rgba(8,13,26,0.95)' : 'transparent',
  },
  inner: {
    flexDirection: 'row',
    paddingTop: 10,
